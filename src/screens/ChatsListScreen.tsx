      ...
      <div className="flex-1 overflow-y-auto p-4 pb-32">
        ...
        {isSupported && !isSubscribed && (
          <motion.div 
            ...
            className="mb-6 p-4 rounded-2xl bg-gradient-to-r from-primary-500/10 to-blue-500/10 border border-primary-500/20 flex items-center justify-between gap-4"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-text-primary-light dark:text-text-primary-dark text-sm">Включить уведомления</h3>
                <p className="text-xs text-text-secondary-light dark:text-text-secondary-dark">Узнавайте о новых сообщениях моментально</p>
              </div>
            </div>
            <button 
              onClick={subscribe}
              className="shrink-0 px-4 py-2 bg-primary-500 text-white text-sm font-bold rounded-xl shadow-md hover:bg-primary-600 transition-colors"
            >
              Включить
            </button>
          </motion.div>
